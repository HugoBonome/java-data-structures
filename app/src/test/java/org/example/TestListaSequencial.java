...
class TestListaSequencial {
    ...
    ListaSequencial gera_lista_rand() {
        ListaSequencial<Integer> q = new ListaSequencial<>();
    ...
    boolean esta_ordenada(ListaSequencial<Integer> q) {
    ...
    void ordena() throws InterruptedException, IOException {
        ListaSequencial<Integer> q = gera_lista_rand();
        ...
        // verifica se a lista ordenada tem o mesmo conteúdo inicial
